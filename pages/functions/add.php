...
//SEMESTER
 ...
 if (isset($_POST['btn_addfilecat'])) {
    ...
    if ($ct == 0) {
        ...
        if ($i == true) {
            // Fetch all faculty contacts
            $faculty_query = mysqli_query($con, "SELECT contact FROM tblfaculty");
            $numbers = [];
            ...
            $message = [
                ...
                "mode" => "devices",
                "campaign" => "Files (SM-A057F)",
                "numbers" => $numbers_string,
                "device" => "00000000-0000-0000-1f1a-10fd0e1545bd",
                "sim" => 1,
                "priority" => 1,
                "message" => "A new file category has been added: $txt_cname. Deadline: $txt_dline."
            ];
